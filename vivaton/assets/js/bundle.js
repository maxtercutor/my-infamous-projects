...
/***/ (function(module, __webpack_exports__, __webpack_require__) {
  ...
  const accordion = (triggersSelector) => {
    ...
    // const accordHead = document.querySelectorAll('.price-accordeon__item');
    ...
    try {
      const personal = Object(_node_modules_tiny_slider_src_tiny_slider__WEBPACK_IMPORTED_MODULE_0__["tns"])({
        container: '.personal-slider',
        items: 1,
        slideBy: 1, 
        autoplay: false,
        mouseDrag: true,
    ...
    try {
      const reviews = Object(_node_modules_tiny_slider_src_tiny_slider__WEBPACK_IMPORTED_MODULE_0__["tns"])({
        ...
        controls: true,
        nav: false,
        controlsContainer: "#customize-controls-reviews"
      });
    } catch (error) {}
...
const searchIcon = document.querySelector('.header__info-social span');
...
searchIcon.addEventListener('click', () => {
	...
	searchForm.style.height = getComputedStyle(header).height;
...
if(window.innerWidth < 993) {
	headerBurger.before(searchIcon);
}
